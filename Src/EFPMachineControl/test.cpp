...
//, _lf_sensor(GPIOA, GPIO_PIN_15P, AnalogInDMAStream(hadc1, 1))
//, _ls_sensor(GPIOB, GPIO_PIN_3, AnalogInDMAStream(hadc1, 2))
//, _rs_sensor(GPIOB, GPIO_PIN_10, AnalogInDMAStream(hadc1, 3))
//, _rf_sensor(GPIOB, GPIO_PIN_2, AnalogInDMAStream(hadc1, 4))
, _lf_sensor(PWMOut(htim2, TIM_CHANNEL_1), AnalogInDMAStream(hadc1, 1))
, _ls_sensor(PWMOut(htim2, TIM_CHANNEL_2), AnalogInDMAStream(hadc1, 2))
, _rs_sensor(PWMOut(htim2, TIM_CHANNEL_3), AnalogInDMAStream(hadc1, 3))
, _rf_sensor(PWMOut(htim2, TIM_CHANNEL_4), AnalogInDMAStream(hadc1, 4))
, _battery(hadc1, 5)
